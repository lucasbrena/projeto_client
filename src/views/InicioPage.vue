                            ...
                            <div class="col">
                                <div class="row">
                                    <div class="qr-content">
                                        <div class="qr-viewfinder">
                                            <v-img src="./assets/comanda-digital.png" alt="QR Code" contain height="95%" style="cursor: pointer;" id="img-btn" @click="onImgClick" />
                                ...
                                <div class="row w-100 justify-center row-2">
                                    <div class="menu-header d-flex flex-column align-center text-center mt-16">
                                        ...
                                        <div class="my-6"></div>
                                        <span class="font-weight-medium">Escaneie o QR Code para começar</span>
                                        <span class="text-capitalize font-weight-black font-h6 mt-10">Olá, {{ cliente.nome || 'User' }}!!</span>
                                    </div>
                                </div>
                            </div>
                        </v-card-text>
